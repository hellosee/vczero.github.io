	...
	a.cgDialog = {
		...
		addButtons: function(m, e) {
			...
			if (m && m.length > 0) {
				...
				for (var g = 0; g < d; g++) {
					var f = m[g];
					var c = a("<span></span>").appendTo(h.ui.buttonsContainer).cgButton(a.extend({}, f, {
						handler: null
					}));
		...
		var b = {
			...
			getDaysHtml: function(t, q, m) {
				var n = "",
					...
					v = new Array(),
					o, u = c.dateToString(m.today, "yyyy-mm-dd");
...
(function(a) {
	a.cgDragSort = {
		_init: function(d, c) {
			...
			b.each(function() {
				var h = a(this),
					f, g = a("<div></div>").addClass(c.className).appendTo("body");
				f = h.cgDrop({
	...
	$.fn.ajaxSubmitForm = function(o) {
		...
		return $(this).each(function() {
			...
			if ($this.validateForm({
				...
				var data = $.extend({}, $this.getFormData({
					delimiter: o.delimiter
				}), o.params || {});
				$.ajax({
					async: o.async,
...
(function(a) {
	a.fn.cgChange = function(b) {
		b = a.extend({}, {
			...
			content: "",
			selectedClass: "",
//			event: "click", //去掉默认事件，wlhmyit@126.com
			beforeChange: null,
			change: null,
			current: 0
		}, b);
			...
			switch (b.effect.type) {
				...
				case "sameDirectionSlide":
					...
					e.picturesContainer.stop(true, true).animate({
						left: f
					}, b.effect.speed, b.effect.easing, function(h) {
						e.finished = true;
